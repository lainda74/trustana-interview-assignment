    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://personal-m6s.sentry.io/issues/?project=4509798365200384">Issues Page</a>.
