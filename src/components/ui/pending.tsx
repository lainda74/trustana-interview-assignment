  ...
  return (
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-sm text-center">
        ...
        <h1 className="mt-12 mb-4 text-2xl tracking-tight font-bold md:text-4xl text-black">
          We&#39;ll Be Back Soon
        </h1>
        <p className="mb-4 text-lg tracking-tight text-grey-400 opacity-75">
          Apologies for the inconvenience! This feature is currently under
          maintenance.
        </p>
      </div>
    </div>
